...
install_prefix = $(install_dir)/opt/fastdds
...
clone:
	git clone --branch=$(BRANCH) --depth=1 https://github.com/eProsima/Fast-DDS.git src

build:
	mkdir $(build_dir)
	(cd $(build_dir); cmake $(source_dir) -DCMAKE_INSTALL_PREFIX=$(install_prefix) -DCMAKE_PREFIX_PATH="$(CMAKE_PREFIX_PATH)")
